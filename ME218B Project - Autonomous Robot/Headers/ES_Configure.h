...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "ComServiceSM.h"
// the name of the Init function
#define SERV_1_INIT InitComServiceSM
// the name of the run function
#define SERV_1_RUN RunComServiceSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER  "UpdateSM.h"
// the name of the Init function
#define SERV_2_INIT  InitUpdateSM
// the name of the run function
#define SERV_2_RUN  RunUpdateSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "StrategySM.h"
// the name of the Init function
#define SERV_3_INIT InitStrategySM
// the name of the run function
#define SERV_3_RUN RunStrategySM
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "TurnFSM.h"
// the name of the Init function
#define SERV_4_INIT InitTurningFSM
// the name of the run function
#define SERV_4_RUN RunTurningFSM
// How big should this services Queue be?
...
typedef enum {  ES_NO_EVENT = 0,
                ...
                ES_UNLOCK, 
								...
								//EventChecker Driven
								TapeFound,
								//Only respond to this if leaving 3 enterring 2 or leaving 5 enterring 1
								...
								//Use for turns and for encoder pos control
								PositionReached,
								TurnComplete,
								StartTurn,
								SamplingComplete,
...
#define EVENT_CHECK_LIST Check4Keystroke, CheckTapeStatus
...
#define TIMER0_RESP_FUNC PostUpdateSM
#define TIMER1_RESP_FUNC PostStrategySM
#define TIMER2_RESP_FUNC PostStrategySM
#define TIMER3_RESP_FUNC PostTurningFSM
#define TIMER4_RESP_FUNC PostComServiceSM
#define TIMER5_RESP_FUNC PostStrategySM
#define TIMER6_RESP_FUNC PostStrategySM
...
#define COM_TIMER 4
#define DRS_TIMER 0
#define FLY_WHEEL_TIMER 1
#define SHOOT_TIMER 2
#define SAMPLING_TIMER 3
#define BACK_GATE_TIMER 5
#define BACK_UP_TIMER 6

#define ALL_BITS (0xff << 2) // differential address to access all bits in register at once
#define FSS_PORT HWREG(GPIO_PORTF_BASE+(GPIO_O_DATA+ALL_BITS))
#define FSS_PIN BIT4HI
